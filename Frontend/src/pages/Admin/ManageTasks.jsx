...
import { LuFileSpreadsheet, LuChevronLeft, LuChevronRight } from "react-icons/lu";
...
const ManageTasks = () => {
  ...
  // Reset to page 1 whenever the status filter changes — avoids landing on
  // a now-invalid page (e.g., page 3 of "Completed" when there's only 1 page)
  useEffect(() => {
    setCurrentPage(1);
  }, [filterStatus]);
